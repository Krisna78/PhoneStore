...
class InvoiceDetailController extends Controller
{
    public function index() {
        ...
        return view('invoiceDetail.index',compact('invoiceDetail'));
    }
    public function create() {
        $invoiceDetail = InvoiceDetail::all();
        return view('invoice.create',compact("invoiceDetail"));
    }
    ...
    public function edit($id) {
        ...
        return view('invoiceDetail.edit',compact('invoiceDetail'));
    }
